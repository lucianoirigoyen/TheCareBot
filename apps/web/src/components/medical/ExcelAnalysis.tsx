...
export function ExcelAnalysis() {
  ...
  const handleAnalysis = async () => {
    ...
    try {
      ...
      const demoResult: ExcelAnalysisResult = {
        rowsProcessed: 247,
        anomaliesDetected: [
          {
            row: 23,
            ...
            type: 'valor_extremo',
            severity: 'high',
            description: 'Valor de glucosa 450 mg/dL muy elevado (normal: 70-100 mg/dL)'
          },
          {
            row: 45,
            column: 'Edad',
            ...
            severity: 'medium',
            description: 'Edad 150 años inconsistente con datos demográficos'
          },
          {
            row: 78,
            column: 'Presión_Sistólica',
            type: 'formato_incorrecto',
            severity: 'low',
            description: 'Formato incorrecto: "120-80" en lugar de valor numérico'
          }
        ],
        insights: [
          {
            category: 'Tendencias Generales',
            insight: 'El 85% de los pacientes muestran niveles de colesterol dentro del rango normal',
            confidence: 0.92
          },
          {
            category: 'Análisis Demográfico',
            insight: 'Mayor prevalencia de diabetes en el grupo etario 45-65 años',
            confidence: 0.88
          },
          {
            category: 'Calidad de Datos',
            insight: 'Se detectaron 3 valores atípicos que requieren validación médica',
            confidence: 0.95
          }
        ],
      ...
      setError('Error al analizar el archivo. Intente nuevamente.')
    } finally {
