...
import { validateChileanRUT, formatRUT } from '../../../../../packages/validators/rut/chilean-rut'
...
export function PatientSearch() {
  ...
  const handleSearch = async () => {
    ...
    // Simulate API call to medical workflow
    try {
      await new Promise(resolve => setTimeout(resolve, 2000))
      
      // Demo response
      const demoResult: PatientSearchResult = {
        found: true,
        demographics: {
          age: 45,
          gender: 'M',
